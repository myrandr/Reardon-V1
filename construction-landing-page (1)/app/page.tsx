...
const featureProjects = [
  {
    ...
    image: "/luxury-modern-residential-building-exterior.jpg",
  ...
  },
  {
    ...
    image: "/architectural-renovation-historic-building.jpg",
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <img
          src="/modern-construction-site-with-steel-beams-and-arch.jpg"
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <div className="text-muted-foreground font-medium">Industry Awards</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <div className="space-y-6 text-lg text-foreground/80 leading-relaxed">
              <p>
                Reardon Builders has established itself as a premier construction firm specializing in large-scale
                commercial and residential developments. Our commitment to exceptional craftsmanship, innovative design
                solutions, and meticulous attention to detail sets us apart in the industry.
              </p>
              <p>
                With three decades of experience, we've successfully completed over 500 projects across the region, from
                luxury residential estates to cutting-edge commercial complexes. Our team of skilled professionals
                brings together architectural vision, engineering precision, and construction expertise to deliver
                projects that exceed expectations.
              </p>
              <p>
                We believe that great buildings are built on strong relationships. From initial consultation to final
                walkthrough, we partner closely with our clients to ensure their vision becomes reality. Our proven
                process, commitment to timelines, and dedication to quality have earned us the trust of developers,
                architects, and property owners throughout the region.
              </p>
            </div>
          </div>
